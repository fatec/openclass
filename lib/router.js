...
Router.route('/reset-password', { name: 'resetPassword', controller: 'ResetPasswordController' });
...
Router.route('/journal/:_id/edit/authors', { name: 'blogEditAuthors', controller: 'BlogEditAuthorsController' });

Router.route('/journal/:_id/edit/categories', { name: 'blogEditCategories', controller: 'BlogEditCategoriesController' });
