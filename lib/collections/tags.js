    ...
    if (addTags.length > 0){
      addTags.forEach(function(tag) {      
          ...
          if(item){
            ...
            if (tag!="")
              Tags.insert({name: tag, blogId: blogId, nRefs: 1});
          }
      });      
    }
