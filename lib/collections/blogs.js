...
Meteor.methods({
    ...
    sendBlog: function(blogAttributes) {
      ...
      var postSize = Posts.find({blogId: blogAttributes.blogId}).count();
      var user = this.userId;

      console.log("CLIENT : On aimerait envoyer le jounal "+blog.title+" et ses "+postSize+" posts");
...
// #############
 ...
 {data:_.extend(blog, posts, {postSize: postSize, userDoingCopy: user}),headers:{"content-type":"application/json"}}, function      (error,result) {
              console.log(result);
            });
// #############
      ...
      post: {
        ...
        action: function () {
          ...
          */
          ...
          console.log("SERVER : On debug la suite après...");
          ...
          if (blog) {
            ...
            Meteor.call('blogCopy',this.bodyParams);
