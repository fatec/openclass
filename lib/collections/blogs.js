...
*/
                ...
                Meteor.http.call("POST",  serverIp+"/api/posts/",
                  {params:{blogId: blog._id, blogTitle: blog.title,posts: postsToCopyOnServer, images: imagesToCopyOnServerString, postsToRemove: removeFromServerIds, userDoingCopy: user}}, function (error,result) {
                    if (error) {
