...
if(Meteor.isClient) {
	...
	FilesCounts = new Mongo.Collection("filesCounts"); // Store post count of a blog ; Allow to count them without subscribe to all posts (optimization)
	ImagesCounts = new Mongo.Collection("imagesCounts"); // Store post count of a blog ; Allow to count them without subscribe to all posts (optimization)
}
