Template.spaceEdit.events({
	...
	'click .space-edit--change-code-button': function(e) {
		e.preventDefault();
		...
		if (newCode && newCode != currentSpaceCode) {
	...
	'click .space-edit--rename-button': function(e) {
		e.preventDefault();
	...
	'click .space-edit--delete-button': function(e) {
		e.preventDefault();
	...
	'click .space-edit--update': function(e, template) {
		e.preventDefault();
